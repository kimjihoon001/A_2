...
def main(args=None):
    ...
    def frame_high_setup():
        ...
        # 액자 하판 위치
        # pos_frame_high0 = posj(30.37, 6.95, 95.37, 95.84, -119.58, -76.33)
    ...
    def Calibration_frame():
        ...
        # ==========================================
        # 종이 정렬 위치 2개
        pos_paper_calx0 = posj(-1.28, -31.68, 111.03, 180.06, -100.58, 88.75) # +x방향으로
        pos_paper_calx1 = posj(-1.25, -31.81, 131.84, 180.07, -79.95, 88.74) # +x방향으로


        pos_paper_caly0 = posx(277.05, 158.74, 390.10, 68.97, 179.95, -21.07) # -y방향으로
        pos_paper_caly1 = posx(277.05, 158.74, 290.10, 68.97, 179.95, -21.07) # -y방향으로
    ...
    def slide_and_pinch_paper():
        ...
        pos_frame_paper0 = posx(288.96, 179.73, 334.59, 91.03, -135.31, 178.80)#종이배치위치1
        pos_frame_paper1 = posx(288.96, 179.73, 444.59, 91.03, -135.31, 178.80)#종이배치위치2
